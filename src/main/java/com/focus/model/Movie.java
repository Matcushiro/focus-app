...
public class Movie {
    ...
    // Новые поля для детского контента
    ...
    public void setTurkish(boolean turkish) { this.turkish = turkish; }

    public boolean isTop10() { return top10; }
    public void setTop10(boolean top10) { this.top10 = top10; }

    public boolean isFeatured() { return featured; }
    public void setFeatured(boolean featured) { this.featured = featured; }

    // Геттеры/сеттеры детского контента
    public boolean isKidsFeatured() { return kidsFeatured; }
    public void setKidsFeatured(boolean kidsFeatured) { this.kidsFeatured = kidsFeatured; }

    public boolean isKidsPopular() { return kidsPopular; }
    public void setKidsPopular(boolean kidsPopular) { this.kidsPopular = kidsPopular; }

    public boolean isKidsLatest() { return kidsLatest; }
    public void setKidsLatest(boolean kidsLatest) { this.kidsLatest = kidsLatest; }
}
